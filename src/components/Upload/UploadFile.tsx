...
export function UploadFile({
  ...
  return (
    <div
      className={`inline-flex items-center bg-tertiary rounded-circle ${className}`}
      style={{
        padding: 'var(--sol-spacing-4) var(--sol-spacing-8)',
        gap: 'var(--sol-spacing-2)',
      }}
    >
      {showIcon && (
        <span className="text-static-white shrink-0" style={{ display: 'block', width: 12, height: 12 }}>
      ...
      <span
        className="text-static-white whitespace-nowrap"
        style={{
