...
<template>
  <div
    :class="`flex flex-col items-center justify-center bg-surface-container border border-border-normal rounded-4 w-full text-left ${$props.class}`"
    style="padding: var(--sol-spacing-24); gap: var(--sol-spacing-8); border-style: dashed"
  >
    <span aria-hidden="true" class="shrink-0 text-element-quaternary" style="display: block; width: 24px; height: 24px">
    ...
    <p
      v-if="text"
      class="text-element-quaternary font-regular text-center"
